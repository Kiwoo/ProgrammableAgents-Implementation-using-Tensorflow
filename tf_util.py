...
class LinearVF_I(object):
    ...
    def predict(self, path):
        return np.zeros(len(path["reward"])) if self.coeffs is None else self._features(
...
def dense(x, size, name, weight_init=None, bias=True, scope=None):
